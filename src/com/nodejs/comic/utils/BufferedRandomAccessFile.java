...
public class BufferedRandomAccessFile extends RandomAccessFile {
	...
	public static void main(String[] args) throws IOException {
		...
		LogUtil.LOGD(TAG,
				"BufferedRandomAccessFile Copy & Write File: " + brafReadFile.filename + "    FileSize: "
		...
		LogUtil.LOGD(TAG,"DataBufferedios Copy & Write File: " + brafReadFile.filename + "    FileSize: "
						+ java.lang.Integer.toString((int) readfilelen >> 1024) + " (KB)    " + "Spend: "
						+ (double) (System.currentTimeMillis() - start) / 1000 + "(s)");
	}
}
